...
class ProteinBackboneWithEmbedding(BaseModel):
  ...
  embedding_320: list[list[float]] | None = None # esm2_t6_8M_UR50D
  embedding_480: list[list[float]] | None = None # esm2_t12_35M_UR50D
  embedding_640: list[list[float]] | None = None # esm2_t30_150M_UR50D
  embedding_1280: list[list[float]] | None = None # esm2_t33_650M_UR50D